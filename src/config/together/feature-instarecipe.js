...
export const TASK = `
Rápidamente explica lo que ves en la imagen: si no aparece ningún alimento escribe únicamente “Eso no es comida.” Si hay comida indica si la imagen es una foto real, un dibujo, pixel art, animación, 2D, 3D u otra representación y, si se trata de una foto de varios ingredientes, genera la lista de ingredientes detectados y las sugerencias de recetas para cada uno de ellos. Si se trata de una foto de un solo ingrediente, indica el ingrediente detectado y máximo 3 sugerencias de recetas para esos ingredientes con una breve descripción de cada receta.
`;
